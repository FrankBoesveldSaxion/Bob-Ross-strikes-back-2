...
public class Player {
    ...
    public void show() {
        ...
        GameApp.addSpriteSheet("bobWalkLeft", "textures/animations/bobRossRunAnimationLeftRun.png", frameWidth, frameHeight);
        GameApp.addAnimationFromSpritesheet("bobWalkLeft", "bobWalkLeft", frameDuration, true);

        GameApp.addSpriteSheet("bobWalkRight", "textures/animations/bobRossRunAnimationRightRun.png", frameWidth, frameHeight);
        GameApp.addAnimationFromSpritesheet("bobWalkRight", "bobWalkRight", frameDuration, true);
    }
